...
public class AutosNuevosController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        LBAcuaticos.setStyle("-fx-background-color:black;");
        LBPesados.setStyle("-fx-background-color:black;");
        vehicles=PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaAutosNuevosController.listaFiltrada);
        ...
        LBAutos.setOnMouseClicked(e->{
            ...
            vehicles =PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaPrincipalController.vehiculosPorTipo(PaginaPrincipalController.vehiculos, a));
        });
        LBMotos.setOnMouseClicked(e->{
            limpiarCampos();
            Tipo m = PaginaPrincipalController.encontrarTipoPorNombre("MOTOS");
            cambiarColorLabel("blue",LBMotos);
            vehicles =PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaPrincipalController.vehiculosPorTipo(PaginaPrincipalController.vehiculos, m));
        });
        LBMaquinarias.setOnMouseClicked(e->{
            ...
            vehicles =PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaPrincipalController.vehiculosPorTipo(PaginaPrincipalController.vehiculos, maq));
        });
        LBPesados.setOnMouseClicked(e->{
            ...
            vehicles =PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaPrincipalController.vehiculosPorTipo(PaginaPrincipalController.vehiculos, p));
        });
        LBAcuaticos.setOnMouseClicked(e->{
            ...
            vehicles =PaginaPrincipalController.llenarVehiculosEnContenedor("Nuevo",fpVehiculos,PaginaPrincipalController.vehiculosPorTipo(PaginaPrincipalController.vehiculos, acua));
        }); 
